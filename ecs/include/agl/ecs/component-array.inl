...
{
	AGL_CORE_ASSERT(m_active_entities[get_index(id_entity)] == true, "Component [{}] is not attached to this entity [{}]", component_type_uid::get_name(component_type_uid::get_id<T>()), id_entity);
...
{
	AGL_CORE_ASSERT(m_active_entities[get_index(id_entity)] == true, "Component [{}] is not attached to this e [{}]", component_type_uid::get_name(component_type_uid::get_id<T>()), id_entity);
